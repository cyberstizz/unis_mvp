...
--
-- Name: refresh_waitlist_counts(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.refresh_waitlist_counts() RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
    REFRESH MATERIALIZED VIEW CONCURRENTLY waitlist_region_counts;
END;
$$;


--
-- Name: waitlist_overview(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.waitlist_overview() RETURNS json
    LANGUAGE plpgsql
    AS $$
DECLARE
    result JSON;
BEGIN
    SELECT json_build_object(
        'totalPreRegistrations', (SELECT COUNT(*) FROM pre_registrations),
        'totalPending', (SELECT COUNT(*) FROM pre_registrations WHERE converted = FALSE),
        'totalConverted', (SELECT COUNT(*) FROM pre_registrations WHERE converted = TRUE),
        'totalArtists', (SELECT COUNT(*) FROM pre_registrations WHERE user_type = 'ARTIST'),
        'totalListeners', (SELECT COUNT(*) FROM pre_registrations WHERE user_type = 'LISTENER'),
        'signupsToday', (SELECT COUNT(*) FROM pre_registrations WHERE DATE(created_at) = CURRENT_DATE),
        'signupsThisWeek', (SELECT COUNT(*) FROM pre_registrations WHERE created_at >= DATE_TRUNC('week', NOW())),
        'statesRepresented', (SELECT COUNT(DISTINCT state_code) FROM pre_registrations),
        'regionsRepresented', (SELECT COUNT(DISTINCT metro_region) FROM pre_registrations),
        'topRegions', (
            SELECT json_agg(row_to_json(t))
            FROM (
                SELECT metro_region, state_code, COUNT(*) as count
                FROM pre_registrations
                WHERE converted = FALSE
                GROUP BY metro_region, state_code
                ORDER BY count DESC
                LIMIT 10
            ) t
        ),
        'recentSignups', (
            SELECT json_agg(row_to_json(t))
            FROM (
                SELECT username, user_type, state_code, metro_region, created_at
                FROM pre_registrations
...
CREATE TABLE public.ad_views (
    ...
    revenue_share numeric(12,6) DEFAULT 0,
    viewed_at timestamp without time zone DEFAULT now(),
    duration_secs integer,
    referrer_level2_id uuid,
    referrer_level3_id uuid
);
...
--
-- Name: jurisdiction_activation_thresholds; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.jurisdiction_activation_thresholds (
    id bigint NOT NULL,
    tier_label character varying(50) NOT NULL,
    min_signups integer NOT NULL,
...
--
-- Name: jurisdiction_activation_thresholds_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.jurisdiction_activation_thresholds_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: jurisdiction_activation_thresholds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.jurisdiction_activation_thresholds_id_seq OWNED BY public.jurisdiction_activation_thresholds.id;
...
CREATE TABLE public.pre_registrations (
    ...
    user_type character varying(20) DEFAULT 'LISTENER'::character varying NOT NULL,
    state_code character varying(2) NOT NULL,
    state_name character varying(100) NOT NULL,
    metro_region character varying(150) NOT NULL,
    city_freetext character varying(150),
    ...
    CONSTRAINT pre_registrations_user_type_check CHECK (((user_type)::text = ANY ((ARRAY['LISTENER'::character varying, 'ARTIST'::character varying])::text[])))
);
...
CREATE TABLE public.users (
    ...
    theme_preference character varying(20) DEFAULT 'blue'::character varying NOT NULL,
...
--
-- Name: waitlist_daily_signups; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.waitlist_daily_signups AS
 SELECT date(created_at) AS signup_date,
  ...
  GROUP BY (date(created_at)), state_code, metro_region
  ORDER BY (date(created_at)) DESC;


--
-- Name: waitlist_referral_leaders; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.waitlist_referral_leaders AS
 SELECT r.referral_code,
   ...
   FROM (public.pre_registrations r
     LEFT JOIN public.pre_registrations ref ON (((ref.referred_by)::text = (r.referral_code)::text)))
  GROUP BY r.id, r.referral_code, r.username, r.display_name, r.state_code, r.metro_region
 HAVING (count(ref.id) > 0)
  ORDER BY (count(ref.id)) DESC;


--
-- Name: waitlist_region_counts; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--

CREATE MATERIALIZED VIEW public.waitlist_region_counts AS
 SELECT state_code,
    state_name,
    metro_region,
    count(*) AS total_signups,
    count(*) FILTER (WHERE ((user_type)::text = 'ARTIST'::text)) AS artist_count,
    count(*) FILTER (WHERE ((user_type)::text = 'LISTENER'::text)) AS listener_count,
    count(*) FILTER (WHERE (converted = false)) AS pending_count,
...
--
-- Name: jurisdiction_activation_thresholds id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jurisdiction_activation_thresholds ALTER COLUMN id SET DEFAULT nextval('public.jurisdiction_activation_thresholds_id_seq'::regclass);
...
ALTER TABLE ONLY public.cron_executions
    ADD CONSTRAINT cron_executions_pkey PRIMARY KEY (execution_id);
...
--
-- Name: jurisdiction_activation_thresholds jurisdiction_activation_thresholds_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.jurisdiction_activation_thresholds
    ADD CONSTRAINT jurisdiction_activation_thresholds_pkey PRIMARY KEY (id);
...
--
-- Name: idx_ad_views_referrer_l2; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ad_views_referrer_l2 ON public.ad_views USING btree (referrer_level2_id, viewed_at);


--
-- Name: idx_ad_views_referrer_l3; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ad_views_referrer_l3 ON public.ad_views USING btree (referrer_level3_id, viewed_at);
...
--
-- Name: idx_cron_executions_job_started; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_cron_executions_job_started ON public.cron_executions USING btree (job_name, started_at DESC);
...
--
-- Name: idx_prereg_converted; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_converted ON public.pre_registrations USING btree (converted);


--
-- Name: idx_prereg_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_created ON public.pre_registrations USING btree (created_at);


--
-- Name: idx_prereg_email; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_email ON public.pre_registrations USING btree (email);


--
-- Name: idx_prereg_metro; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_metro ON public.pre_registrations USING btree (metro_region);


--
-- Name: idx_prereg_referral; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_referral ON public.pre_registrations USING btree (referral_code);


--
-- Name: idx_prereg_referred_by; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_referred_by ON public.pre_registrations USING btree (referred_by);


--
-- Name: idx_prereg_state; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_state ON public.pre_registrations USING btree (state_code);


--
-- Name: idx_prereg_state_metro; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_state_metro ON public.pre_registrations USING btree (state_code, metro_region);


--
-- Name: idx_prereg_username; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_prereg_username ON public.pre_registrations USING btree (username);
...
CREATE INDEX idx_users_stripe_account ON public.users USING btree (stripe_account_id) WHERE (stripe_account_id IS NOT NULL);
...
--
-- Name: idx_wrc_state_metro; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_wrc_state_metro ON public.waitlist_region_counts USING btree (state_code, metro_region);
...
--
-- Name: ad_views ad_views_referrer_level2_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ad_views
    ADD CONSTRAINT ad_views_referrer_level2_fkey FOREIGN KEY (referrer_level2_id) REFERENCES public.users(user_id);


--
-- Name: ad_views ad_views_referrer_level3_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ad_views
    ADD CONSTRAINT ad_views_referrer_level3_fkey FOREIGN KEY (referrer_level3_id) REFERENCES public.users(user_id);
...
ALTER TABLE ONLY public.payouts
    ADD CONSTRAINT payouts_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
--
-- Name: songs songs_clean_version_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.songs
    ADD CONSTRAINT songs_clean_version_id_fkey FOREIGN KEY (clean_version_id) REFERENCES public.songs(song_id);
