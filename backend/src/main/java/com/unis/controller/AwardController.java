...
public class AwardController {
    ...
    // GET /api/v1/awards/leaderboards?type={type}&intervalId={id}&jurisdictionId={id} (page 4 leaderboards)
    ...
    // GET /api/v1/awards/past?type={type}&startDate={date}&endDate={date}&jurisdictionId={id} (page 5 milestones)
    @GetMapping("/past")
